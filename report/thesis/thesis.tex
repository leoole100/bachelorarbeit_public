...
Polarized photoluminescence has been identified as the most promising optical measurement technique for studying the magnetic phase transition in the selected materials.\\
...
% First I want a paragraph with background information and motivation, where I introduce van der Wals antiferromagnets, give a bit of background into the structure and, just mention interesting optical and magnetic properties.
...
% Then a Research gap paragraph where I explain, that it is difficult to determine the structure, especially fast and in situ.
...
%Clearly state the goal of your research, which is to develop a technique for detecting magnetic structures or phase changes, even down to monolayer limits.
...
% Then limit the expectation that the interpretation of the entire magnetic dependent light-matter interaction process is out of scope for this work.
...
% Then outline the thesis by explaining that in the methodology section, different methods were tried until polarized photoluminescence spectroscopy was found to be the most promising. And that in the result section two materials were studied with this method. That NiPS3 showed behavior that could not be explained by current theoretical models and in CrPS4 phase transitions were successfully observed using this method. 
...
\todo{Short description of spectrometer}
