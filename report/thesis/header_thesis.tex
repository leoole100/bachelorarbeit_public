...
% change to colored underline
% \setkomafont{chapter}{\color{seeblau}\Huge\bfseries}
% \setkomafont{section}{\color{seeblau}\Large\bfseries}
% \setkomafont{chapter}{\Huge\bfseries\adjustbox{padding=3pt, bgcolor=seeblau, margin=-1pt}}
